  ...
  def getAction(self, gameState: GameState) -> str:
    ...
    def maxValue(gameState, depth, alpha, beta):
        ...
        for action in gameState.getLegalActions(0):
            ...
            new_value = minValue(successor, depth, 1, alpha, beta)
            if new_value > value:
    ...
    def minValue(gameState, depth, agentIndex, alpha, beta):
        ...
        for successor in successors:
            if agentIndex == gameState.getNumAgents() - 1:
                new_value = maxValue(successor, depth + 1, alpha, beta)[0]
            else:
                new_value = minValue(successor, depth, agentIndex + 1, alpha, beta)
    ...
    value, best_action = maxValue(gameState, 0, float('-inf'), float('inf'))
    return best_action
